...
const BrandListPage = () => {
  ...
  const fetchDataUrl = apis.brand.getAll;
  const singleDeleteUrl = apis.brand.deleteSingle;
  const updateStatusUrl = apis.brand.update;
  ...
  return (
    <div className="container mt-1">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h5>Brand<span className="badge bg-secondary ms-2">{total}</span></h5>
        <Link to="/brand/add"><button className="btn btn-primary">Add New</button></Link>
