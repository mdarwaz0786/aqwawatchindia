...
const ProductListPage = () => {
  ...
  const fetchDataUrl = apis.product.getAll;
  const singleDeleteUrl = apis.product.deleteSingle;
  const updateStatusUrl = apis.product.update;
  ...
  return (
    <div className="container mt-1">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h5>Products<span className="badge bg-secondary ms-2">{total}</span></h5>
        <Link to="/product/add"><button className="btn btn-primary">Add New</button></Link>
