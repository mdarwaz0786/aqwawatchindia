...
const CarouselListPage = () => {
  ...
  const fetchDataUrl = apis.carousel.getAll;
  const singleDeleteUrl = apis.carousel.deleteSingle;
  const updateStatusUrl = apis.carousel.update;
  ...
  return (
    <div className="container mt-1">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h5>Carousel<span className="badge bg-secondary ms-2">{total}</span></h5>
        <Link to="/carousel/add"><button className="btn btn-primary">Add New</button></Link>
              ...
              <tr key={item?._id}>
                ...
                <td>
                  <div className="d-flex flex-wrap gap-2">
                    <Link to={`/carousel/update/${item?._id}`}>
