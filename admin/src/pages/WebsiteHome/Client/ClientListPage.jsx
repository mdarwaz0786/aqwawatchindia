...
const ClientListPage = () => {
  ...
  const fetchDataUrl = apis.client.getAll;
  const singleDeleteUrl = apis.client.deleteSingle;
  const updateStatusUrl = apis.client.update;
  ...
  return (
    <div className="container mt-1">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h5>Client<span className="badge bg-secondary ms-2">{total}</span></h5>
        <Link to="/client/add"><button className="btn btn-primary">Add New</button></Link>
              ...
              <tr key={item?._id}>
                ...
                <td>
                  <div className="d-flex flex-wrap gap-2">
                    <Link to={`/client/update/${item?._id}`}>
