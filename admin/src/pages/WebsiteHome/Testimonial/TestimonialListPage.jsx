...
const TestimonialListPage = () => {
  ...
  const fetchDataUrl = apis.testimonial.getAll;
  const singleDeleteUrl = apis.testimonial.deleteSingle;
  const updateStatusUrl = apis.testimonial.update;
  ...
  return (
    <div className="container mt-1">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h5>Testimonial<span className="badge bg-secondary ms-2">{total}</span></h5>
        <Link to="/testimonial/add"><button className="btn btn-primary">Add New</button></Link>
