...
const YouTubeVideoListPage = () => {
  ...
  const fetchDataUrl = apis.youTubeVideo.getAll;
  const singleDeleteUrl = apis.youTubeVideo.deleteSingle;
  const updateStatusUrl = apis.youTubeVideo.update;
  ...
  return (
    <div className="container mt-1">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h5>Youtube Video<span className="badge bg-secondary ms-2">{total}</span></h5>
        <Link to="/youtube-video/add"><button className="btn btn-primary">Add New</button></Link>
              ...
              <tr key={item?._id}>
                ...
                <td>
                  <div className="d-flex flex-wrap gap-2">
                    <Link to={`/youtube-video/update/${item?._id}`}>
