...
const BlogCategoryListPage = () => {
  ...
  const fetchDataUrl = apis.blogCategory.getAll;
  const singleDeleteUrl = apis.blogCategory.deleteSingle;
  const updateStatusUrl = apis.blogCategory.update;
  ...
  return (
    <div className="container mt-1">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h5>Blog Category<span className="badge bg-secondary ms-2">{total}</span></h5>
        <Link to="/blog-category/add"><button className="btn btn-primary">Add New</button></Link>
              ...
              <tr key={item?._id}>
                ...
                <td>
                  <div className="d-flex flex-wrap gap-2">
                    <Link to={`/blog-category/update/${item?._id}`}>
