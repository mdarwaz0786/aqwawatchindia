          ...
          <div className="row">
            <div className="col-lg-7 d-none d-lg-block">
              <ul className="topbar_info d-flex flex-wrap">
                ...
                <li>
                  <p><i className="fal fa-map-marker-alt" /> New York, United States</p>
                </li>
              </ul>
            </div>
              ...
              <div className="main_menu_area">
                ...
                <ul className="menu_icon">
                  {/* <li>
                    <a href="compare.php">
                      <b>
                        <img src="assets/images/compare_black.svg" alt="Wishlist" className="img-fluid" />
                      </b>
                      <span>2</span>
                    </a>
                  </li>
                  ...
                  <li>
                    <a className="user" href="dashboard.php">
                      <b>
      ...
      <div className="mini_cart">
        <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
          ...
          <div className="offcanvas-body">
            <ul>
              <li>
                <Link to="/product-detail" className="cart_img">
